...
AIS-026 (init-harness token-weight refactor) pushed to main (2a89c9d).
AIS-027 (init-harness dogfood fixes + evals from first real-world run) committed — pending push.
